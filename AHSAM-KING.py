#created by AHSAM UL HAQ 
#tottaly written by Mr AUH 
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
\033[1;33m |/     \||/   \__/  |/     \|(_______)|/     \|                                                                                         
 \033[1;32m  ╔════════════════════════════════════╗
 \033[1;32m  ║😈[•] Facebook' : AHSAM UL HAQ     
\033[1;32m   ║😈[•] Whatsapp' : 03411471937 
 \033[1;32m  ║😈[•] Github    : MR-AUH404
 \033[1;32m  ║😈[•] Status    : FREE            
  \033[1;32m ║😈[•] Network   : 3G, 4G/5G,WIFI ON       
 \033[1;32m  ║😈[•] Version   : 9.0               
 \033[1;32m  ║😈[•] Tools     : RANDOM-OK             
 \033[1;32m  ╚════════════════════════════════════╝"""
clear()
os.system("xdg-open https://youtube.com/channel/ahsamkitrikes82000")
xxxx = str(len(ugen))
...
def main():
    ...
    print('\033[1;97m====================================================') 
    print(f"\033[1;97m[01] \033[1;92mRANDOM CLONING-[FIRE] ")
    ...
    if adi in ["1","01"]:
        ...
        os.system("xdg-open https://facebook.com/AHSAM.JOIYA")
        main()
    elif adi in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print('\033[1;97m====================================================') 
    print(f'\033[1;97m[!] \033[1;92mBD SIM CODES  \033[1;91m: \033[1;96m+88017, +88019, +88018, +88016')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AHSAM] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
